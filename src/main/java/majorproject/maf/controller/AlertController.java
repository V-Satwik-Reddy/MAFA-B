...
public class AlertController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<AlertResponseDto>> createAlert(@RequestBody AlertRequestDto alert, Authentication authentication) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<AlertResponseDto>> deleteAlert(@PathVariable long id, Authentication authentication) {
        UserDto userDto = (UserDto) authentication.getPrincipal();
